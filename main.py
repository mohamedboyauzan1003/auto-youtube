...
# ═══════════════════════════════════════════════════════════
#  GROQ — historia continua de 5 escenas para Short de 10-12s
#  Estructura: Gancho → Por qué → Identificación → Consecuencia → Cierre abierto
# ═══════════════════════════════════════════════════════════
def generate_script():
    ...
    prompt = (
        ...
        "Especializacion: psicologia aplicada a jovenes de 15 a 24 anos.\n"
        "Has creado cientos de Shorts virales. Sabes exactamente como funciona la retencion.\n"
        "Tu cerebro no genera frases. Genera historias que atrapan desde la primera palabra.\n\n"

        f"HOY TIENES QUE ESCRIBIR UN SHORT SOBRE: {topic}\n\n"

        "=== LO MAS IMPORTANTE ===\n"
        "No escribas 5 frases sobre el tema.\n"
        "Escribe UNA HISTORIA DE 10 SEGUNDOS dividida en 5 escenas.\n"
        "La historia debe tener inicio, desarrollo, tension y pregunta final.\n"
        "Cada escena es la consecuencia directa de la anterior.\n"
        "Si lees las 5 escenas seguidas, deben sonar como una sola frase larga.\n\n"

        "=== TEST QUE DEBES SUPERAR ANTES DE ESCRIBIR ===\n"
        "Pregunta 1: Si elimino la escena 2, las escenas 3, 4 y 5 dejan de tener sentido?\n"
        "Pregunta 2: Si elimino la escena 3, las escenas 4 y 5 dejan de tener sentido?\n"
        "Si la respuesta a alguna de estas preguntas es NO, el guion esta mal. Rehazlo.\n\n"

        "=== ESTRUCTURA OBLIGATORIA ===\n\n"

        "ESCENA 1 — GANCHO (5-7 palabras):\n"
        "La primera frase de la historia. Describe algo muy concreto del tema.\n"
        "NO es un dato. Es una situacion que el espectador reconoce de su vida.\n"
        "Debe crear esta pregunta en su cabeza: por que me pasa eso?\n"
        "Nunca la respondas aqui. Solo abre la herida.\n"
        "PROHIBIDO: hooks genericos como 'Tu cerebro te engana' o 'Las relaciones son dificiles'.\n"
        "OBLIGATORIO: que suene a una situacion real, especifica, que te duele reconocer.\n\n"

        "ESCENA 2 — CAUSA PARCIAL (5-7 palabras):\n"
        "Responde a medias la pregunta de la escena 1. Solo a medias.\n"
        "Abre una pregunta nueva: y eso por que ocurre?\n"
        "Debe sonar como la continuacion natural de la frase anterior.\n"
        "Si pones 'Pero...' o 'Y...' al inicio, debe encajar perfectamente.\n\n"

        "ESCENA 3 — MECANISMO CONCRETO (5-7 palabras):\n"
        "Aqui explicas el por que real. Con una imagen mental muy concreta.\n"
        "El espectador debe pensar: eso es exactamente lo que hago.\n"
        "Usa '...' en esta frase para la pausa de reconocimiento.\n"
        "Ejemplo concreto correcto: 'Revisas conversaciones que... pasaron hace meses.'\n"
        "Ejemplo vago incorrecto: 'Tu mente no puede descansar.'\n\n"

        "ESCENA 4 — CONSECUENCIA (5-7 palabras):\n"
        "Muestra el coste real de lo que describiste en la escena 3.\n"
        "Debe conectar directamente: lo que haces en la escena 3 provoca esto.\n"
        "Aumenta la tension. No resuelvas nada todavia.\n"
        "Palabras utiles: cada vez que / sin que lo notes / y asi.\n\n"

        "ESCENA 5 — PREGUNTA FINAL (5-7 palabras):\n"
        "La unica respuesta posible es en comentarios.\n"
        "Debe ser personal, directa, sobre el tema exacto.\n"
        "Que suene como la pregunta que el espectador ya se estaba haciendo.\n"
        "PROHIBIDO: dale like, sigueme, comparte, guarda este video.\n"
        "PROHIBIDO: preguntas genericas como 'Te ha pasado?' sin contexto.\n\n"

        "=== CADENA DE CURIOSIDAD ===\n"
        "La retencion funciona asi: cada escena cierra una pregunta y abre otra.\n"
        "Escena 1: abre pregunta A.\n"
        "Escena 2: responde A a medias, abre pregunta B.\n"
        "Escena 3: responde B con un ejemplo real, abre pregunta C.\n"
        "Escena 4: responde C mostrando el coste, abre pregunta D.\n"
        "Escena 5: pregunta D se convierte en la pregunta final del video.\n"
        "Nunca cierres completamente una idea. Siempre deja algo sin resolver.\n\n"

        "=== EJEMPLOS DE MICROHISTORIA CORRECTA ===\n\n"

        "Tema: la psicologia de dejarte en visto\n"
        "E1: Te dejo en visto y no puedes ignorarlo.\n"
        "E2: Porque tu cerebro lo interpreta como rechazo.\n"
        "E3: Y revisas el mensaje... buscando haber fallado.\n"
        "E4: Cada vez que lo haces, te enganchas mas.\n"
        "E5: Cuanto tiempo llevas esperando esa respuesta?\n\n"

        "Tema: por que tu ex vuelve cuando ya lo habias superado\n"
        "E1: Siempre vuelve justo cuando lo superas.\n"
        "E2: No es casualidad. Detecta cuando te alejas.\n"
        "E3: Y manda ese mensaje que... lo cambia todo.\n"
        "E4: Sin que lo notes, vuelves a empezar de cero.\n"
        "E5: Cuantas veces has vuelto a ese ciclo?\n\n"

        "Tema: como los narcisistas hacen que te sientas culpable\n"
        "E1: Siempre acabas pidiendo perdon tu primero.\n"
        "E2: Aunque no hayas hecho nada malo.\n"
        "E3: Porque aprendieron a hacer que te sientas... responsable de su dolor.\n"
        "E4: Y cada vez que cedes, les das mas poder.\n"
        "E5: De quien lo aprendiste a tolerar?\n\n"

        "=== EJEMPLOS DE MICROHISTORIA INCORRECTA (PROHIBIDOS) ===\n\n"

        "Tema: pensar demasiado por la noche\n"
        "E1: Tu cerebro te engana. [PROHIBIDO: generico, no es del tema]\n"
        "E2: Las relaciones son complicadas. [PROHIBIDO: cambio de tema]\n"
        "E3: Piensas demasiado. [PROHIBIDO: vago, sin imagen concreta]\n"
        "E4: Eso afecta tu vida. [PROHIBIDO: no conecta con la escena 3]\n"
        "E5: Te ha pasado? [PROHIBIDO: pregunta sin contexto]\n\n"

        "=== PROHIBICIONES ABSOLUTAS ===\n"
        "PROHIBIDO cambiar de tema en ninguna escena.\n"
        "PROHIBIDO introducir un concepto psicologico distinto al del tema.\n"
        "PROHIBIDO usar frases genericas que podrian ir en cualquier video.\n"
        "PROHIBIDO sonar como una IA. Cada frase debe sonar humana y directa.\n"
        "PROHIBIDO usar palabras tecnicas o academicas.\n"
        "PROHIBIDO relleno: en realidad, de hecho, basicamente, es importante que.\n"
        "PROHIBIDO cerrar la historia antes de la escena 5.\n\n"

        "=== EMOCION DOMINANTE ===\n"
        "Antes de escribir, elige UNA emocion para todo el video:\n"
        "curiosidad / sorpresa / incomodidad / identificacion / misterio\n"
        "Todas las escenas deben reforzar esa misma emocion.\n"
        "No mezcles emociones. Un video, una emocion.\n\n"

        "=== TITULO ===\n"
        "Maximo 55 caracteres. Especifico. Que prometa algo concreto.\n"
        "Buenos: 'Por que nunca puedes olvidarle' / 'Tu cerebro hace esto cada noche'\n"
        "Malos: 'La verdad sobre tu mente' / 'Psicologia importante'\n\n"

        "=== REGLAS DE ESCRITURA ===\n"
        "- Todo en espanol. Tutear siempre.\n"
        "- 5-7 palabras por escena. NUNCA 8 o mas.\n"
        "- Total: 25-35 palabras en las 5 escenas.\n"
        "- Nivel de lectura de un adolescente de 15 anos.\n"
        "- Cada palabra debe aportar algo. Si puedes eliminarla, eliminala.\n"
        "- '...' solo en la escena 3.\n\n"

        "=== IMAGENES (prompts en ingles, 40-60 palabras por imagen) ===\n"
        "Las 5 imagenes deben contar la misma historia que el texto, visualmente.\n"
        "El escenario debe ser coherente en todo el video (mismo universo visual):\n"
        "  Tema nocturno/mental: bedroom pantalla azul, calle neon noche, metro vacio.\n"
        "  Tema social/relaciones: cafeteria, pasillo instituto, parque noche.\n"
        "  Tema interno/autoestima: espejo, habitacion oscura, lavabo.\n"
        "Composicion progresiva que sigue la tension de la historia:\n"
        "  Escena 1: Extreme close-up face — impacto inicial, tension en los ojos\n"
        "  Escena 2: Medium shot torso up — revelacion, cuerpo en tension\n"
        ...
        "  mascara cayendo / cuerda invisible en el pecho / ojos multiples en el fondo.\n"
        "Paleta de color coherente en las 5 imagenes segun la emocion del video:\n"
        "  incomodidad/tension: azul frio + rojo oscuro\n"
        "  misterio/revelacion: morado + dorado\n"
        "  soledad/identificacion: azul frio + gris\n"
        "Siempre incluir: cinematic, 8k, ultra detailed, masterpiece, no text, no watermark, 9:16 vertical.\n\n"

        "=== FORMATO DE RESPUESTA ===\n"
        "Devuelve UNICAMENTE JSON valido. Ni una sola palabra fuera del JSON.\n"
        "{\n"
        "  \"title\": \"titulo especifico maximo 55 caracteres\",\n"
        "  \"description\": \"resumen de la historia en 15-20 palabras\",\n"
        "  \"tags\": [\"psicologia\",\"mente\",\"cerebro\",\"manipulacion\",\"relaciones\",\"autoestima\",\"shorts\",\"viral\",\"jovenes\",\"comportamiento\"],\n"
        "  \"scenes\": [\n"
        "    {\"text\": \"escena 1\", \"prompt\": \"imagen 1 en ingles\"},\n"
        "    {\"text\": \"escena 2\", \"prompt\": \"imagen 2 en ingles\"},\n"
        "    {\"text\": \"escena 3\", \"prompt\": \"imagen 3 en ingles\"},\n"
        "    {\"text\": \"escena 4\", \"prompt\": \"imagen 4 en ingles\"},\n"
        "    {\"text\": \"escena 5\", \"prompt\": \"imagen 5 en ingles\"}\n"
        "  ]\n"
        "}\n\n"
