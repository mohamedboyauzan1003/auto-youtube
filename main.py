...
def generate_script():
    ...
    prompt = (
        "Eres el mejor guionista de mini documentales de psicologia del mundo.\n"
        "Escribes para jovenes de 16 a 24 anos en TikTok e Instagram Reels.\n"
        "Tu unico objetivo: que el video se vea completo, se repita en bucle y genere comentarios.\n\n"
        f"TEMA UNICO DEL VIDEO: {topic}\n\n"
        "== REGLA PRINCIPAL: HISTORIA UNICA EN 5 ESCENAS ==\n"
        "NO escribas 5 frases independientes sobre psicologia.\n"
        "Escribe UNA SOLA HISTORIA dividida en 5 escenas sobre el tema exacto de arriba.\n"
        "Si eliminas cualquier escena, la historia debe dejar de tener sentido.\n"
        "PROHIBIDO introducir temas distintos al indicado en ninguna escena.\n"
        "PROHIBIDO cambiar de tema a mitad del video.\n"
        "Todo el video explora EXCLUSIVAMENTE: " + topic + "\n\n"
        "== ESTRUCTURA NARRATIVA OBLIGATORIA ==\n\n"
        "ESCENA 1 - GANCHO (5-7 palabras):\n"
        "El inicio de la historia. Relacionado DIRECTAMENTE con el tema.\n"
        "Golpea al espectador con algo que describe exactamente lo que le ocurre.\n"
        "Crea una pregunta mental urgente: por que me pasa esto?\n"
        "El espectador debe pensar 'eso me pasa a mi' y parar el scroll.\n\n"
        "ESCENA 2 - POR QUE OCURRE (5-7 palabras):\n"
        "Responde parcialmente la pregunta de la escena 1.\n"
        "Explica brevemente la causa, pero abre una nueva pregunta.\n"
        "El espectador debe pensar: y eso que significa para mi?\n"
        "MISMO TEMA. No introduzcas nada nuevo.\n\n"
        "ESCENA 3 - IDENTIFICACION (5-7 palabras):\n"
        "Pon al espectador dentro de una situacion concreta del tema.\n"
        "Una imagen mental especifica que reconozca de su propia vida.\n"
        "Usa '...' para la pausa dramatica de reconocimiento.\n"
        "El espectador debe pensar: exactamente eso hago yo.\n"
        "MISMO TEMA. No introduzcas nada nuevo.\n\n"
        "ESCENA 4 - CONSECUENCIA (5-7 palabras):\n"
        "Revela que seguir haciendo eso tiene un coste psicologico real.\n"
        "Conecta directamente con lo que dijo la escena 3.\n"
        "Usa: cada vez que / sin que lo notes / en este momento.\n"
        "El espectador debe sentir urgencia de resolver esto.\n"
        "MISMO TEMA. No introduzcas nada nuevo.\n\n"
        "ESCENA 5 - CIERRE ABIERTO (5-7 palabras):\n"
        "Cierra la historia pero deja una pregunta sin responder.\n"
        "Debe ser una pregunta personal y directa sobre el tema.\n"
        "Solo se puede responder en comentarios.\n"
        "NUNCA: dale like, sigueme, comparte.\n"
        "MISMO TEMA. No introduzcas nada nuevo.\n\n"
        "== RETENCION: CADENA DE CURIOSIDAD ==\n"
        "Escena 1 crea una pregunta. Escena 2 responde a medias y abre otra.\n"
        "Escena 3 responde a medias y abre otra. Escena 4 aumenta la tension.\n"
        "Escena 5 da una respuesta parcial y cierra con pregunta para comentarios.\n"
        "Nunca cierres completamente el tema antes del final.\n\n"
        "== EJEMPLO CORRECTO (tema: pensar demasiado por la noche) ==\n"
        "Escena 1: Son las 3am y tu mente no para.\n"
        "Escena 2: No es insomnio. Es tu cerebro en modo alerta.\n"
        "Escena 3: Revisas conversaciones que... pasaron hace meses.\n"
        "Escena 4: Cada noche asi te cuesta energia real.\n"
        "Escena 5: A que hora suele empezar el tuyo?\n\n"
        "== EJEMPLO INCORRECTO (prohibido) ==\n"
        "Escena 1: Tu cerebro te engana. [tema: pensar por la noche]\n"
        "Escena 2: Las relaciones son dificiles. [CAMBIO DE TEMA: prohibido]\n"
        "Escena 3: Piensas demasiado. [vago, sin conexion con escena 2]\n"
        "Escena 4: Eso afecta tu vida. [generico, no conecta con nada]\n"
        "Escena 5: Te ha pasado? [pregunta sin contexto]\n\n"
        "== REGLAS DE ESCRITURA ==\n"
        "- TODO en espanol, tutear siempre\n"
        "- Cada frase: 5-7 palabras MAXIMO. Nunca 8 o mas.\n"
        "- Total del guion: 25-35 palabras\n"
        "- Cero palabras academicas ni tecnicas\n"
        "- Cero relleno: en realidad, de hecho, basicamente, recuerda que\n"
        "- Una sola idea por escena\n"
        "- '...' solo en la escena 3, nunca en las demas\n"
        "- Cada frase debe sonar como la continuacion natural de la anterior\n\n"
        "== REGLAS DE IMAGENES (prompts en ingles, 40-60 palabras) ==\n"
        "Las imagenes deben contar visualmente la misma historia que el texto.\n"
        "Composicion progresiva por escena:\n"
        "  Escena 1: Extreme close-up face — tension inicial\n"
        "  Escena 2: Medium shot torso up — revelacion creciente\n"
        "  Escena 3: Dutch angle medium shot — identificacion, inestabilidad\n"
        "  Escena 4: Over-the-shoulder or POV — consecuencia personal\n"
        "  Escena 5: Direct eye contact with camera — pregunta directa al espectador\n"
        "Protagonista: joven 18-22 anos, streetwear, hoodie oversized.\n"
        "Escenario coherente con el tema (mismo universo visual en las 5 escenas):\n"
        "  Si el tema es nocturno: bedroom con luz de pantalla, calle neon.\n"
        "  Si el tema es social: cafeteria, instituto, metro.\n"
        "  Si el tema es interno: espejo, habitacion oscura, lavabo.\n"
        "Un simbolo psicologico distinto por imagen pero coherente con el tema:\n"
        ...
        "Paleta de luz coherente en todo el video:\n"
        "  azul frio=soledad/noche, rojo=peligro/tension, morado=poder/revelacion, dorado=claridad.\n"
        "Siempre incluir: cinematic, 8k, ultra detailed, masterpiece, no text, no watermark, 9:16 vertical.\n\n"
        "== FORMATO DE RESPUESTA ==\n"
        "Devuelve UNICAMENTE JSON valido. Ni una palabra fuera del JSON.\n"
        "{\n"
        "  \"title\": \"titulo llamativo maximo 55 caracteres relacionado con el tema\",\n"
        "  \"description\": \"una frase de 15-20 palabras que resume la historia del video\",\n"
