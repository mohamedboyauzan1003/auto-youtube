...
def generate_script():
    ...
    prompt = (
        ...
        "- Each image prompt: describe a SPECIFIC visually striking dark anime scene that MATCHES the exact emotion of that line\\n"
        "  The image must show something the viewer has never seen — surprising composition, unexpected visual metaphor\\n"
...
def generate_image(prompt, index):
    ...
    full_prompt = (f"{style}, {prompt}, masterpiece, best quality, ultra detailed, 8k, "
...
with open("/mnt/user-data/outputs/main.py","w",encoding="utf-8") as f:
    f.write(code.lstrip("\\n"))
print("Written OK, lines:", len(code.splitlines()))
